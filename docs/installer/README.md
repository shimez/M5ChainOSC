...
Web Installerには、GitHub ActionsでビルドしてGitHub Releaseへ添付したmergedバイナリを、Pages配信Workflowが自動的に組み込みます。Version 1.6.1では次のパスで配信します。

```text
installer/firmware/M5ChainOSC-1.6.1-AtomS3R-merged.bin
```
