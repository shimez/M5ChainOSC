...
Web Installerには、GitHub ActionsでビルドしてGitHub Releaseへ添付したmergedバイナリを、Pages配信Workflowが自動的に組み込みます。Version 1.12.4では次のパスで配信します。

```text
installer/firmware/M5ChainOSC-1.12.4-AtomS3R-merged.bin
```
